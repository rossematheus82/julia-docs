...
export const MEDICAMENTOS: Medicamento[] = [
  ...
  { id: 'dpoc-becfor-gli', nome: 'Dipropionato de beclometasona 100 mcg + brometo de glicopirrônio 12,5 mcg + fumarato de formoterol 6 mcg', apresentacao: 'solução aerossol 120 doses', idadeMinima: 18, doenca: 'dpoc' },
  ...
  { id: 'dpoc-for6bud200po', nome: 'Formoterol 6 mcg + Budesonida 200 mcg', apresentacao: 'pó inalante 60 doses', idadeMinima: 0, doenca: 'dpoc' },
  { id: 'dpoc-for12bud400po', nome: 'Formoterol 12 mcg + Budesonida 400 mcg', apresentacao: 'pó inalante 60 doses', idadeMinima: 0, doenca: 'dpoc' },
...
const SUGESTOES_POSOLOGIA: Record<string, { inicial: SugestaoPosologia; manutencao: SugestaoPosologia }> = {
  ...
  'dpoc-for12bud400po': mesma({ posologia: 'Realizar 1 inalação, via oral, de 12/12 horas.' }),
